 ...
 */
            ...
            /**
            *  CDMPersonSchemaRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CDMPersonSchemaRequest
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "hrc:pds:transform:CDMpersonschema",
                "CDMPersonSchemaRequest",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CDMPersonSchemaRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CDMPersonSchemaRequest",
    ...
    public static class Factory{
        ...
        */
        public static CDMPersonSchemaRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CDMPersonSchemaRequest object =
                new CDMPersonSchemaRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CDMPersonSchemaRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CDMPersonSchemaRequest)cdmpersonschema.transform.pds.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
