 ...
 */
            ...
            /**
            *  ReactivateIssuance bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReactivateIssuance
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReactivateIssuance",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ReactivateIssuance",
    ...
    public static class Factory{
        ...
        */
        public static ReactivateIssuance parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReactivateIssuance object =
                new ReactivateIssuance();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReactivateIssuance".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReactivateIssuance)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
