 ...
 */
            ...
            /**
            *  UpdateEmployeeContractor bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateEmployeeContractor
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateEmployeeContractor",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateEmployeeContractor",
    ...
    public static class Factory{
        ...
        */
        public static UpdateEmployeeContractor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateEmployeeContractor object =
                new UpdateEmployeeContractor();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateEmployeeContractor".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateEmployeeContractor)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
