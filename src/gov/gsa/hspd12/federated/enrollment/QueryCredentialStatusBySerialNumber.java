...
/**
 * QueryCredentialStatusBySerialNumber.java
 *
 ...
 */
            ...
            /**
            *  QueryCredentialStatusBySerialNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryCredentialStatusBySerialNumber
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected int localQueryList ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localQueryListTracker = false ;

                           public boolean isQueryListSpecified(){
                               return localQueryListTracker;
                           }
                           ...
                           */
                           public  int getQueryList(){
                            ...
                            /**
                               ...
                               */
                               public void setQueryList(int param){
                            
                                       // setting primitive attribute tracker to true
                                       localQueryListTracker =
                                       param != java.lang.Integer.MIN_VALUE;
                                   
                                            this.localQueryList=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryCredentialStatusBySerialNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryCredentialStatusBySerialNumber",
                ...
                if (localTransactionHeaderTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localQueryListTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "queryList", xmlWriter);
                             
                                               if (localQueryList==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("queryList cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQueryList));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTransactionHeaderTracker){
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localQueryList));
                            }
    ...
    public static class Factory{
        ...
        */
        public static QueryCredentialStatusBySerialNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryCredentialStatusBySerialNumber object =
                new QueryCredentialStatusBySerialNumber();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryCredentialStatusBySerialNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryCredentialStatusBySerialNumber)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","queryList").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setQueryList(java.lang.Integer.MIN_VALUE);
