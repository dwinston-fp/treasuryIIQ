...
/**
 * CreateNewEmployeeContractorResponse.java
 *
 ...
 */
            ...
            /**
            *  CreateNewEmployeeContractorResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateNewEmployeeContractorResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://hspd12.gsa.gov/federated/enrollment",
                "CreateNewEmployeeContractorResponse",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CreateNewEmployeeContractorResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CreateNewEmployeeContractorResponse",
    ...
    public static class Factory{
        ...
        */
        public static CreateNewEmployeeContractorResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateNewEmployeeContractorResponse object =
                new CreateNewEmployeeContractorResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CreateNewEmployeeContractorResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateNewEmployeeContractorResponse)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
