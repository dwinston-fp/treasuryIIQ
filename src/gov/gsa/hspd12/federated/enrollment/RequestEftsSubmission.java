 ...
 */
            ...
            /**
            *  RequestEftsSubmission bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RequestEftsSubmission
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for RequesterPID
                        */

                        
                                    protected java.lang.String localRequesterPID ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRequesterPIDTracker = false ;

                           public boolean isRequesterPIDSpecified(){
                               return localRequesterPIDTracker;
                           }
                           ...
                           */
                           public  java.lang.String getRequesterPID(){
                               return localRequesterPID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RequesterPID
                               */
                               public void setRequesterPID(java.lang.String param){
                            localRequesterPIDTracker = true;
                                   
                                            this.localRequesterPID=param;
                        ...
                        /**
                        * field for RequestOrganizationalIdentifier
                        */

                        
                                    protected java.lang.String localRequestOrganizationalIdentifier ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRequestOrganizationalIdentifierTracker = false ;

                           public boolean isRequestOrganizationalIdentifierSpecified(){
                               return localRequestOrganizationalIdentifierTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getRequestOrganizationalIdentifier(){
                               return localRequestOrganizationalIdentifier;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RequestOrganizationalIdentifier
                               */
                               public void setRequestOrganizationalIdentifier(java.lang.String param){
                            localRequestOrganizationalIdentifierTracker = true;
                                   
                                            this.localRequestOrganizationalIdentifier=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":RequestEftsSubmission",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "RequestEftsSubmission",
                ...
                if (localTransactionHeaderTracker){
                                ...
                                } if (localRequesterPIDTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "requesterPID", xmlWriter);
                             

                                          if (localRequesterPID==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localRequesterPID);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localRequestOrganizationalIdentifierTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "requestOrganizationalIdentifier", xmlWriter);
                             

                                          if (localRequestOrganizationalIdentifier==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localRequestOrganizationalIdentifier);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                    ...
                                    localPersonIdentifier);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                         ...
                                         elementList.add(localRequesterPID==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequesterPID));
                                    } if (localRequestOrganizationalIdentifierTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                                                      "requestOrganizationalIdentifier"));
                                 
                                         elementList.add(localRequestOrganizationalIdentifier==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequestOrganizationalIdentifier));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static RequestEftsSubmission parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RequestEftsSubmission object =
                new RequestEftsSubmission();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RequestEftsSubmission".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RequestEftsSubmission)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","requesterPID").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","requestOrganizationalIdentifier").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setRequestOrganizationalIdentifier(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
