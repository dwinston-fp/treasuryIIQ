...
/**
 * DeleteEmployeeContractorResponse.java
 *
 ...
 */
            ...
            /**
            *  DeleteEmployeeContractorResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteEmployeeContractorResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://hspd12.gsa.gov/federated/enrollment",
                "DeleteEmployeeContractorResponse",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for RecordDeleted
                        */

                        
                                    protected boolean localRecordDeleted ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRecordDeletedTracker = false ;

                           public boolean isRecordDeletedSpecified(){
                               return localRecordDeletedTracker;
                           }
                           ...
                           */
                           public  boolean getRecordDeleted(){
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RecordDeleted
                               */
                               public void setRecordDeleted(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       localRecordDeletedTracker =
                                       true;
                                   
                                            this.localRecordDeleted=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteEmployeeContractorResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteEmployeeContractorResponse",
                ...
                if (localTransactionHeaderTracker){
                                ...
                                } if (localRecordDeletedTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "recordDeleted", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("recordDeleted cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRecordDeleted));
                                               }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTransactionHeaderTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRecordDeleted));
                            } if (localTransactionStatusTracker){
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                                                      "transactionStatus"));
    ...
    public static class Factory{
        ...
        */
        public static DeleteEmployeeContractorResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteEmployeeContractorResponse object =
                new DeleteEmployeeContractorResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteEmployeeContractorResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteEmployeeContractorResponse)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","recordDeleted").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRecordDeleted(
