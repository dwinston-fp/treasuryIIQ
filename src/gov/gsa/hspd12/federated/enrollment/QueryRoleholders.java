 ...
 */
            ...
            /**
            *  QueryRoleholders bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryRoleholders
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryRoleholders",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryRoleholders",
    ...
    public static class Factory{
        ...
        */
        public static QueryRoleholders parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryRoleholders object =
                new QueryRoleholders();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryRoleholders".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryRoleholders)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
