 ...
 */
            ...
            /**
            *  DeleteEmployeeContractor bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DeleteEmployeeContractor
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for DeletionReasonCode
                        */

                        
                                    protected java.lang.String localDeletionReasonCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDeletionReasonCodeTracker = false ;

                           public boolean isDeletionReasonCodeSpecified(){
                               return localDeletionReasonCodeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getDeletionReasonCode(){
                               return localDeletionReasonCode;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param DeletionReasonCode
                               */
                               public void setDeletionReasonCode(java.lang.String param){
                            localDeletionReasonCodeTracker = true;
                                   
                                            this.localDeletionReasonCode=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteEmployeeContractor",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteEmployeeContractor",
                ...
                if (localTransactionHeaderTracker){
                                ...
                                } if (localDeletionReasonCodeTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "deletionReasonCode", xmlWriter);
                             

                                          if (localDeletionReasonCode==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localDeletionReasonCode);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                    ...
                                    localPersonIdentifier);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                         ...
                                         elementList.add(localDeletionReasonCode==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDeletionReasonCode));
                                    } if (localCommentsTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                                                      "comments"));
    ...
    public static class Factory{
        ...
        */
        public static DeleteEmployeeContractor parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteEmployeeContractor object =
                new DeleteEmployeeContractor();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteEmployeeContractor".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DeleteEmployeeContractor)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","deletionReasonCode").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","comments").equals(reader.getName())){
