 ...
 */
            ...
            /**
            *  AdjudicationInformationE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AdjudicationInformationE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localAdjudicationInformation==null){
                                        ...
                                        writeStartElement(null, namespace, "AdjudicationInformation", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localAdjudicationInformation.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localAdjudicationInformation==null){
                                   ...
                                   return localAdjudicationInformation.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static AdjudicationInformationE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AdjudicationInformationE object =
                new AdjudicationInformationE();
