 ...
 */
            ...
            /**
            *  RequestDNSync bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RequestDNSync
    ...
    public static class Factory{
        ...
        */
        public static RequestDNSync parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RequestDNSync object =
                new RequestDNSync();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"RequestDNSync".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RequestDNSync)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
