 ...
 */
            ...
            /**
            *  CredentialCheckInStatusE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CredentialCheckInStatusE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localCredentialCheckInStatus==null){
                                        ...
                                        writeStartElement(null, namespace, "CredentialCheckInStatus", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localCredentialCheckInStatus.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localCredentialCheckInStatus==null){
                                   ...
                                   return localCredentialCheckInStatus.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CredentialCheckInStatusE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CredentialCheckInStatusE object =
                new CredentialCheckInStatusE();
