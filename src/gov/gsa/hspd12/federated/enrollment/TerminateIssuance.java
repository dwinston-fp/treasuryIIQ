 ...
 */
            ...
            /**
            *  TerminateIssuance bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TerminateIssuance
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                           ...
                           */
                           public  int getIssuanceID(){
                            ...
                            /**
                               ...
                               */
                               public void setIssuanceID(int param){
                        ...
                        /**
                        * field for TerminationReasonCode
                        */

                        
                                    protected java.lang.String localTerminationReasonCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTerminationReasonCodeTracker = false ;

                           public boolean isTerminationReasonCodeSpecified(){
                               return localTerminationReasonCodeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getTerminationReasonCode(){
                               return localTerminationReasonCode;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param TerminationReasonCode
                               */
                               public void setTerminationReasonCode(java.lang.String param){
                            localTerminationReasonCodeTracker = true;
                                   
                                            this.localTerminationReasonCode=param;
                        ...
                        /**
                        * field for MarkDestroyed
                        */

                        
                                    protected boolean localMarkDestroyed ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMarkDestroyedTracker = false ;

                           public boolean isMarkDestroyedSpecified(){
                               return localMarkDestroyedTracker;
                           }
                           ...
                           * @return boolean
                           */
                           public  boolean getMarkDestroyed(){
                               return localMarkDestroyed;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MarkDestroyed
                               */
                               public void setMarkDestroyed(boolean param){
                            
                                       // setting primitive attribute tracker to true
                                       localMarkDestroyedTracker =
                                       true;
                                   
                                            this.localMarkDestroyed=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TerminateIssuance",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "TerminateIssuance",
                ...
                if (localTransactionHeaderTracker){
                                    ...
                                    writeStartElement(null, namespace, "issuanceID", xmlWriter);
                                               ...
                                               if (localIssuanceID==java.lang.Integer.MIN_VALUE) {
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTerminationReasonCodeTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "terminationReasonCode", xmlWriter);
                             

                                          if (localTerminationReasonCode==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localTerminationReasonCode);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localMarkDestroyedTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "markDestroyed", xmlWriter);
                             
                                               if (false) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("markDestroyed cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMarkDestroyed));
                                               }
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIssuanceID));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                         ...
                                         elementList.add(localTerminationReasonCode==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localTerminationReasonCode));
                                    } if (localMarkDestroyedTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                                                      "markDestroyed"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMarkDestroyed));
                            }
    ...
    public static class Factory{
        ...
        */
        public static TerminateIssuance parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TerminateIssuance object =
                new TerminateIssuance();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TerminateIssuance".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TerminateIssuance)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        reader.next();
                                               ...
                                               object.setIssuanceID(java.lang.Integer.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","terminationReasonCode").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setTerminationReasonCode(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","markDestroyed").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMarkDestroyed(
