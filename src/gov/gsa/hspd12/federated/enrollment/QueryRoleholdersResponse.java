 ...
 */
            ...
            /**
            *  QueryRoleholdersResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryRoleholdersResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://hspd12.gsa.gov/federated/enrollment",
                "QueryRoleholdersResponse",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for Roleholders
                        */

                        
                                    protected com.eds.www.assuredidentity.ArrayOfRoleholderInformation localRoleholders ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRoleholdersTracker = false ;

                           public boolean isRoleholdersSpecified(){
                               return localRoleholdersTracker;
                           }
                           ...
                           */
                           public  com.eds.www.assuredidentity.ArrayOfRoleholderInformation getRoleholders(){
                               return localRoleholders;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param Roleholders
                               */
                               public void setRoleholders(com.eds.www.assuredidentity.ArrayOfRoleholderInformation param){
                            localRoleholdersTracker = true;
                                   
                                            this.localRoleholders=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryRoleholdersResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryRoleholdersResponse",
                ...
                if (localTransactionHeaderTracker){
                                ...
                                } if (localRoleholdersTracker){
                                    if (localRoleholders==null){

                                        writeStartElement(null, "http://hspd12.gsa.gov/federated/enrollment", "roleholders", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localRoleholders.serialize(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","roleholders"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTransactionHeaderTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                    ...
                                    elementList.add(localRoleholders==null?null:
                                    localRoleholders);
                                }
    ...
    public static class Factory{
        ...
        */
        public static QueryRoleholdersResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryRoleholdersResponse object =
                new QueryRoleholdersResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryRoleholdersResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryRoleholdersResponse)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","roleholders").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setRoleholders(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setRoleholders(com.eds.www.assuredidentity.ArrayOfRoleholderInformation.Factory.parse(reader));
