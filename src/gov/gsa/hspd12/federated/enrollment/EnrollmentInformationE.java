 ...
 */
            ...
            /**
            *  EnrollmentInformationE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EnrollmentInformationE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localEnrollmentInformation==null){
                                        ...
                                        writeStartElement(null, namespace, "EnrollmentInformation", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localEnrollmentInformation.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localEnrollmentInformation==null){
                                   ...
                                   return localEnrollmentInformation.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static EnrollmentInformationE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EnrollmentInformationE object =
                new EnrollmentInformationE();
