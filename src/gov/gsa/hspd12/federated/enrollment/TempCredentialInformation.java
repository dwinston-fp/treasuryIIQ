...
/**
 * TempCredentialInformation.java
 *
 ...
 */
            ...
            /**
            *  TempCredentialInformation bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class TempCredentialInformation
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = TempCredentialInformation
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for IssuanceReason
                        */

                        
                                    protected java.lang.String localIssuanceReason ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localIssuanceReasonTracker = false ;

                           public boolean isIssuanceReasonSpecified(){
                               return localIssuanceReasonTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getIssuanceReason(){
                               return localIssuanceReason;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IssuanceReason
                               */
                               public void setIssuanceReason(java.lang.String param){
                            localIssuanceReasonTracker = true;
                                   
                                            this.localIssuanceReason=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":TempCredentialInformation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localCardAuthenticationCertificateTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localIssuanceReasonTracker){
                                    namespace = "http://hspd12.gsa.gov/federated/enrollment";
                                    writeStartElement(null, namespace, "IssuanceReason", xmlWriter);
                             

                                          if (localIssuanceReason==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localIssuanceReason);
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIssuanceID));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                         ...
                                         elementList.add(localIssuanceReason==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIssuanceReason));
                                    } if (localPivAuthenticationCertificateTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
    ...
    public static class Factory{
        ...
        */
        public static TempCredentialInformation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TempCredentialInformation object =
                new TempCredentialInformation();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"TempCredentialInformation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (TempCredentialInformation)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","IssuanceReason").equals(reader.getName())){
