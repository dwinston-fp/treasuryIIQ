 ...
 */
            ...
            /**
            *  QueryCredentialStatus bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryCredentialStatus
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryCredentialStatus",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryCredentialStatus",
    ...
    public static class Factory{
        ...
        */
        public static QueryCredentialStatus parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryCredentialStatus object =
                new QueryCredentialStatus();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryCredentialStatus".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryCredentialStatus)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
