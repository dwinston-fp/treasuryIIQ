...
/**
 * QueryCardActionStateResponse.java
 *
 ...
 */
            ...
            /**
            *  QueryCardActionStateResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryCardActionStateResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://hspd12.gsa.gov/federated/enrollment",
                "QueryCardActionStateResponse",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for CardActionInformation
                        */

                        
                                    protected gov.gsa.hspd12.federated.enrollment.CardActionInformation localCardActionInformation ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localCardActionInformationTracker = false ;

                           public boolean isCardActionInformationSpecified(){
                               return localCardActionInformationTracker;
                           }
                           ...
                           /**
                           * Auto generated getter method
                           * @return gov.gsa.hspd12.federated.enrollment.CardActionInformation
                           */
                           public  gov.gsa.hspd12.federated.enrollment.CardActionInformation getCardActionInformation(){
                               return localCardActionInformation;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param CardActionInformation
                               */
                               public void setCardActionInformation(gov.gsa.hspd12.federated.enrollment.CardActionInformation param){
                            localCardActionInformationTracker = true;
                                   
                                            this.localCardActionInformation=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryCardActionStateResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryCardActionStateResponse",
                ...
                if (localTransactionHeaderTracker){
                                ...
                                } if (localCardActionInformationTracker){
                                    if (localCardActionInformation==null){

                                        writeStartElement(null, "http://hspd12.gsa.gov/federated/enrollment", "cardActionInformation", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localCardActionInformation.serialize(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","cardActionInformation"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localTransactionHeaderTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                    ...
                                    elementList.add(localCardActionInformation==null?null:
                                    localCardActionInformation);
                                } if (localTransactionStatusTracker){
                            elementList.add(new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment",
                                                                      "transactionStatus"));
    ...
    public static class Factory{
        ...
        */
        public static QueryCardActionStateResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryCardActionStateResponse object =
                new QueryCardActionStateResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryCardActionStateResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryCardActionStateResponse)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://hspd12.gsa.gov/federated/enrollment","cardActionInformation").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setCardActionInformation(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setCardActionInformation(gov.gsa.hspd12.federated.enrollment.CardActionInformation.Factory.parse(reader));
