 ...
 */
            ...
            /**
            *  AgencySpecificCriteriaE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AgencySpecificCriteriaE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localAgencySpecificCriteria==null){
                                        ...
                                        writeStartElement(null, namespace, "AgencySpecificCriteria", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localAgencySpecificCriteria.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localAgencySpecificCriteria==null){
                                   ...
                                   return localAgencySpecificCriteria.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static AgencySpecificCriteriaE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AgencySpecificCriteriaE object =
                new AgencySpecificCriteriaE();
