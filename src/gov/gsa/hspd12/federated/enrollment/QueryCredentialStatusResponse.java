...
/**
 * QueryCredentialStatusResponse.java
 *
 ...
 */
            ...
            /**
            *  QueryCredentialStatusResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class QueryCredentialStatusResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":QueryCredentialStatusResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "QueryCredentialStatusResponse",
    ...
    public static class Factory{
        ...
        */
        public static QueryCredentialStatusResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            QueryCredentialStatusResponse object =
                new QueryCredentialStatusResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"QueryCredentialStatusResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (QueryCredentialStatusResponse)gov.gsa.hspd12.federated.enrollment.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
