...
/**
 * IssuanceValidationStatusE.java
 *
 ...
 */
            ...
            /**
            *  IssuanceValidationStatusE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IssuanceValidationStatusE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localIssuanceValidationStatus==null){
                                        ...
                                        writeStartElement(null, namespace, "IssuanceValidationStatus", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localIssuanceValidationStatus.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localIssuanceValidationStatus==null){
                                   ...
                                   return localIssuanceValidationStatus.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static IssuanceValidationStatusE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IssuanceValidationStatusE object =
                new IssuanceValidationStatusE();
